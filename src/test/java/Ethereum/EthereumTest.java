...
//			System.out.println(ethereum.getAddress(ethereum.publicKey(privateKey)));
	...
	public void testSeed() {
		...
		assertEquals(ethereum.getAddress(ethereum.publicKey(ethereum.newPrivateKey(seed))),
				ethereum.getAddress(ethereum.publicKey(ethereum.newPrivateKey(seed))));
	}

	@Test
	public void randomnessTest() {
		assertNotEquals(ethereum.getAddress(ethereum.publicKey(ethereum.newPrivateKey())),
				ethereum.getAddress(ethereum.publicKey(ethereum.newPrivateKey())));
