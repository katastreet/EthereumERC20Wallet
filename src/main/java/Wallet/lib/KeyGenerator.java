...
public class KeyGenerator {
    ...
    public ExtendedKey createExtendedKeyFromPassphrase(String passphrase, byte[] encryptedBytes) throws ValidationException {
        try {
    ...
    public ECKeyPair createECKeyPair(KeyPair keyPair) {
        ...
        BigInteger publicKeyValue =
                new BigInteger(1, java.util.Arrays.copyOfRange(publicKeyBytes, 1, publicKeyBytes.length));
